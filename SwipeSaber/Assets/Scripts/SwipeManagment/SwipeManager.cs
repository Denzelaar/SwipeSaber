...
public class SwipeManager : MonoBehaviour
{
    ...
    public System.Action<SwipeDirection> onSwipeDirection;
    public System.Action<Vector2, Vector2> onSwipePos;
    ...
    public void DetectSwipe()
    {
        ...
        if (touches.Count > 0)
        {
            ...
            if (t.phase == TouchPhase.Ended)
            {
                ...
                onSwipeDirection?.Invoke(currentSwipeAction.direction);
                onSwipePos?.Invoke(currentSwipeAction.startPosition, currentSwipeAction.endPosition);

                /*Debug.Log(currentSwipeAction.startPosition);
                GameObject henkk1 =  Instantiate(prefab, canvas);
                henkk1.transform.position = currentSwipeAction.startPosition;

                GameObject henkk21 =  Instantiate(prefab, canvas);
                henkk1.transform.localPosition = currentSwipeAction.startPosition;       
                */
